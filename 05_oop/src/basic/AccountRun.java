...
//		a1.password = "1q2w3e4r";
		...
		// 간접 접근 기능을 이용해 세팅 
		// (Account page에서 Private를 해버리면 이 페이지에서 볼 수 없어서 setter 기능을 써야 함
		a1.setName("홍길동");
...
//		a1.password = "asdf1234";
		...
		a1.withdraw("zxcvasdf", 2000000); // 비밀번호 불일치인 경우
		a1.withdraw("1q2w3e4r", 2000000); // 잔액 부족인 경우
		a1.withdraw("1q2w3e4r", 7000); // 출금 성공
		a1.withdraw("1q2w3e4r", 8000); // 나머지 모두 출금
