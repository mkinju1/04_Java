...
public class OperatorEx {
	...
	// method == 객체(클래스)가 가지고 있는 기능(funcition)
	...
	public void method1() {
		...
		// 10 + 3 = 13 ln과 f 두 방법 중 ln은 주석처리 하고 f로 해 봄
	...
	public void method4() {
		...
		// 1 ~ 20 사이 난수
		int randomNumber = (int) (Math.random() * 10 + 1); // int로 강제 형변 (소수점 날림)
