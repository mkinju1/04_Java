...
public class VarialbeEx3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("이 번호 : " + (int)'이'); // 
		System.out.println("홍 번호 : " + (int)'홍'); // 
		System.out.println("종 번호 : " + (int)'종'); // 
		...
		// NATIONAL_CODE =11; // 파이널 뒤에 정의하려고 하면 오류 발생(값 대입 불가)
