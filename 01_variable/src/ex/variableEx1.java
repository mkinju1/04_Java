...
public class variableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - 논리형 -
		 * boolean (1byte) - 저장할 수 있는 값은 true/false 만
		 * 
		 * - 정수형 -
		 * byte		(1byte)
		 * short	(2byte)
		 * int		(4byte) - 정수 기본형(123 등 숫자를 쓰면 쓰면 int로 인식)
		 * long		(8byte) - 숫자 뒤에 l또는L(소문자 대문자 L) (ex : 123L)
		 * 
		 * - 실수형 -
		 * float	(4byte) - 숫자 뒤에 f 또는 F (ex : 3.14f)
		 * double	(8byte) - 실수 기본형
		 * 
		 * - 문자형 -
		...
		int num1; // 메모리에 int형 데이터를 저장하기위한 
				  // 공간 4byte를 할당하고 변수 이름을 num1 이라고 지정

		// 자바는 초기화(처음 값 대입)되지않은
		// 지역변수를 출력, 연산할 수 없다(대입 연산만 가능)
		...
		// 변수에 값 대입
		num1 = 2000;
		System.out.println(num1); // 값이 대입되면 오류 없음
		...
		// long longNum = 2147483648; // 일반 정수값은 int로(기본형) 인식됨
		long longNum = 2147483648l; // 뒤에 엘을 붙이면 long 표기로 됨
		...
		// [실수형]
		float floatNum = 1.23f; // 뒤의 에프는 float 자료형이란 뜻
